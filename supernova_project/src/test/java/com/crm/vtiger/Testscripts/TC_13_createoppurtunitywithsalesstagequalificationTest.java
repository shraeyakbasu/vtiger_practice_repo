...
public class TC_13_createoppurtunitywithsalesstagequalificationTest extends Baseclass
{
	
	@Test(groups = "regression")
	public void creatopptwithsalesstagequal() throws IOException
	{
...
//creating opportunity with sales stage qualification
		
		Vtigercreatingnewoppoutunity vcno=new Vtigercreatingnewoppoutunity(driver);
		vcno.createopportunitywithsalesstagequalification(expectedoppname);
