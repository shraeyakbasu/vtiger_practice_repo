...
public class TC_15_createoppurtunitywithsalesstagevaluepropositionTest extends Baseclass
{
	
	
	@Test(groups = "regression")
	public void createoppwithsalesstagevalueproposition() throws IOException
	{
...
//creating opportunity with sales stage value proposition
				
		Vtigercreatingnewoppoutunity vcno=new Vtigercreatingnewoppoutunity(driver);
		vcno.createopportunitywithsalesstagevalueproposition(expectedoppname);
