...
public class TC_14_createoppurtunitywithsalesstageneedanalysisTest extends Baseclass
{
	

	@Test(groups = "regression")
	public void createoppuwithsalesstageneedanal() throws IOException
	{
		...
		//creating opportunity with sales stage need analysis
				
		Vtigercreatingnewoppoutunity vcno=new Vtigercreatingnewoppoutunity(driver);
		vcno.createopportunitywithsalesstageneedanalysis(expectedoppname);
